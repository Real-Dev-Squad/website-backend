...
import { createRequest, getRequestByKeyValues, updateRequest } from "../models/requests.js";
...
} from "../types/onboardingExtension.js";
...
export const updateOnboardingExtensionRequestState = async (
  ...
  try {
    ...
    const [logType, returnMessage] =
      response.state === REQUEST_STATE.APPROVED
...
export const updateOnboardingExtensionRequestController = async (
  ...
  try {
    ...
    const requestBody = await updateOnboardingExtensionRequest(id, body, lastModifiedBy);
