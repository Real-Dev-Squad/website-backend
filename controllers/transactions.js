...
const fetchTransactionByUsername = async (req, res) => {
  try {
    ...
    if (userId) {
      ...
      const data = await transactionsModel.fetchTransactionByUsername(userId, offset, limit, orderBy)
      return res.json({
