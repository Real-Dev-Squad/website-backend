...
app.use("/issues", require("./issues.ts"));
app.use("/progresses", require("./progresses.ts"));
app.use("/monitor", require("./monitor.js"));
app.use("/staging", require("./staging.ts"));
app.use("/goals", require("./goals.ts"));
module.exports = app;
