...
router.patch("/users/:userId", authenticate, authorizeRoles([SUPERUSER]), users.updateUser);
router.get("/users/suggestedUsers/:skillId", authenticate, authorizeRoles([SUPERUSER]), users.getSuggestedUsers);
