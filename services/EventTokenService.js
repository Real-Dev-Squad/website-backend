...
class EventTokenService {
  static #app_access_key = process.env.LIVE_APP_ACCESS_KEY || config.get("Event100ms.APP_ACCESS_KEY");
  static #app_secret = process.env.LIVE_APP_SECRET || config.get("Event100ms.APP_SECRET");
  #managementToken;
  constructor() {
