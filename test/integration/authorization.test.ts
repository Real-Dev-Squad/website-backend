...
const pongHandler = (_: any, res: any) => {
...
describe('authorizeUser', function () {
  let defaultJwt: any, appOwnerJwt: any, superUserJwt: any
  ...
  it('should authorize default user for route with no required role', function (done: any) {
    chai
      .request(app)
      .get('/for-everyone')
  ...
  // @ts-expect-error ts-migrate(2582) FIXME: Cannot find name 'it'. Do you need to install type... Remove this comment to see the full error message
  it('should authorize user with role for route with no required role', function (done: any) {
    chai
      .request(app)
      .get('/for-everyone')
  ...
  // @ts-expect-error ts-migrate(2582) FIXME: Cannot find name 'it'. Do you need to install type... Remove this comment to see the full error message
  it('should authorize appOwner for route with appOwner required role', function (done: any) {
    chai
      .request(app)
      .get('/for-app-owner')
      .set('cookie', `${cookieName}=${appOwnerJwt}`)
  ...
  // @ts-expect-error ts-migrate(2582) FIXME: Cannot find name 'it'. Do you need to install type... Remove this comment to see the full error message
  it('should not allow user not having role for route with appOwner required role', function (done: any) {
    chai
      .request(app)
      .get('/for-app-owner')
      .set('cookie', `${cookieName}=${defaultJwt}`)
  ...
  // @ts-expect-error ts-migrate(2582) FIXME: Cannot find name 'it'. Do you need to install type... Remove this comment to see the full error message
  it('should authorize superUser for route with appOwner required role', function (done: any) {
    chai
      .request(app)
      .get('/for-app-owner')
  ...
  // @ts-expect-error ts-migrate(2582) FIXME: Cannot find name 'it'. Do you need to install type... Remove this comment to see the full error message
  it('should authorize superUser for route with superUser required role', function (done: any) {
    chai
      .request(app)
      .get('/for-super-user')
      .set('cookie', `${cookieName}=${superUserJwt}`)
  ...
  // @ts-expect-error ts-migrate(2582) FIXME: Cannot find name 'it'. Do you need to install type... Remove this comment to see the full error message
  it('should not allow appOwner for route with superUser required role', function (done: any) {
    chai
      .request(app)
      .get('/for-super-user')
      .set('cookie', `${cookieName}=${appOwnerJwt}`)
