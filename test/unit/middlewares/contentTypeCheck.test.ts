...
describe('contentTypeCheck', function () {
  ...
  it('should return 415 error when content-type application/json is not passed', function (done: any) {
    chai
      .request(app)
      .post('/users')
  ...
  // @ts-expect-error ts-migrate(2582) FIXME: Cannot find name 'it'. Do you need to install type... Remove this comment to see the full error message
  it('should process the request when no content-type is passed', function (done: any) {
    chai
      .request(app)
      .get('/healthcheck')
      .end((err: any, res: any) => {
  ...
  // @ts-expect-error ts-migrate(2582) FIXME: Cannot find name 'it'. Do you need to install type... Remove this comment to see the full error message
  it('should process the request when content-type application/json is passed', function (done: any) {
    chai
      .request(app)
      .patch('/users/self')
