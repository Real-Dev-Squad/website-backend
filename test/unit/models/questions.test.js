...
describe("Questions", function () {
  ...
  describe("createQuestion", function () {
    it("should create a question in db with the given data and is_new and max_words should be added by default if not provided", async function () {
      ...
      expect(result.max_words).to.equal(null);
      expect(result.is_new).to.equal(true);
    });

    it("should create a question in db with the given data and is_new should be default to true and max_words should be added as provided", async function () {
      ...
      expect(result.is_new).to.equal(true);
      expect(result.max_words).to.equal(questionDataWithMaxWords.maxWords);
    });
  });
});
